...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['hospital-owner', 'hospital-staff', 'doctor'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Blog', path: '/blogs', entity: 'blog', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    { name: 'Gallery', path: '/galleries', entity: 'gallery', service: AccessServiceEnum.PROJECT, icon: FiImage },
    {
      name: 'Social Media',
      path: '/social-medias',
      entity: 'social_media',
